...
Report bugs at {{ cookiecutter.remote_git_repo }}/issues.
...
The best way to send feedback is to file an issue at {{ cookiecutter.remote_git_repo }}/issues.
...
Bump the version in `{{ cookiecutter.project_slug }}/__init__.py` and
